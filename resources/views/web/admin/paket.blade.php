...
@section('konten')
            ...
            <div class="container">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title"><i class="fas fa-cubes"></i> Paket</h4>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-plus"></i> Tambah Paket</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
							</button>
						</div>
						<div class="modal-body">
							<form id="create_paket">
                                ...
                                <div class="form-group">
									...
									<input type="number" name="durasi_paket" class="form-control" value="0">
			...
			<div class="modal fade" id="exampleModalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalEditLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalEditLabel"><i class="fa fa-edit"></i> Edit Paket</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
							</button>
						</div>
...
<script>
	  ...
	  const table = $('#basic-datatables').DataTable({
		  ...
		  columns: [
			  ...
			  {data: 'deskripsi_paket', name: 'deskripsi_paket'},
	  ...
	  $('#create_paket').submit(function(e){
		e.preventDefault();
		...
		$.ajax({
			...
			success:function(res){
				...
				if($.isEmptyObject(res.error)){
					...
					swal("Berhasil!", "Paket berhasil ditambah!", {
							icon : "success",
							buttons: {        			
								confirm: {
				...
				swal({
					...
					if (willDelete) {
						...
						$.ajax({
							...
							data: {data:data},
							success:function(res){
								swal("Berhasil! Paket berhasil dihapus!", {
									icon: "success",
									buttons : {
										confirm : {
											className: 'btn btn-primary btn-round'
		...
		$('body').on('submit','#edit_paket',function(e){
			  e.preventDefault();
			  const data = $(this).serialize();
			  $.ajax({
				url: "{{url('/paket')}}",
				...
				success:function(res){
					...
					if($.isEmptyObject(res.error)){
						...
						swal("Berhasil!", "Paket berhasil diedit!", {
								icon : "success",
								buttons: {        			
									confirm: {
										className : 'btn btn-primary btn-round'
